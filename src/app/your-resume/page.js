...
const page = () => {
    ...
    return (
        <>
            <div class="bg-gray-100 p-4" id="pdf-content">

                <div class="border-1 shadow-lg shadow-gray-700 rounded-lg">

                    {/* <!-- top content --> */}
                    <div class="flex rounded-t-lg bg-[#8e4d57] sm:px-2 w-full" id="pdf-content">
                        ...
                        <div class="w-2/3 sm:text-center pl-5 mt-10 text-start">
                            ...
                            <p class="text-heading text-white">Software Engineer</p>
                        </div>
                        ...
                        <div class="flex flex-col sm:flex-row sm:mt-10">
                            ...
                            <div class="flex flex-col sm:w-1/3">
                                    ...
                                    <div>
                                        <div class="flex items-center my-1">
                                            <a class="w-6 text-gray-700 hover:text-orange-600">
                                                <Image src={LinkedIcon} height={14} width={14} />
                                            </a>
                                ...
                                <div class="py-3 sm:order-none order-2">
                                    ...
                                    <div class="border-2 w-20 border-top-color mb-2"></div>
                ...
                <button onClick={convertToPdf} className='bg-red-500 p-4 roun'><Image src={DownloadIcon} height={50} width={50} /></button>
            </div>
        </>
    )
}
