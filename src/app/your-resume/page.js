        ...
        <>
            <div className="bg-gray-100 p-4" id="pdf-content">
                ...
                <div className="border-1 shadow-lg shadow-gray-700 rounded-lg">
                    ...
                    {/* <!-- top content --> */}
                    <div className="flex rounded-t-lg bg-[#8e4d57] sm:px-2 w-full" id="pdf-content">
                        ...
                        <div className="w-2/3 sm:text-center pl-5 mt-10 text-start">
                            ...
                            <p className="text-heading text-white">Software Engineer</p>
                        </div>
                                    ...
                                    <div>
                                        <div className="flex items-center my-1">
                                            <a className="w-6 text-gray-700 hover:text-orange-600">
                                                <Image src={LinkedIcon} height={14} width={14} alt='linkedIcon' />
                                            </a>
                ...
                <button onClick={convertToPdf} className='bg-red-500 p-4 h-50 w-50 rounded-full fixed right-4 bottom-4'><Image src={DownloadIcon} height={20} width={20} alt='DownloadIcon' /></button>
            </div>
        </>
    )
}
